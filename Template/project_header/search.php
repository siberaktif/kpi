    ...
    <form method="get" action="<?= $this->url->dir() ?>" class="search">
        ...
        <div class="input-addon">
            ...
            <div class="input-addon-item">
                <?= $this->render('KPI:app/filters_helper', array('reset' => 'KPI:', 'project' => $project)) ?>
            </div>
            ...
            <div class="input-addon-item">
                <div class="dropdown">
                    ...
                    <ul>
                        <li><a href="#" class="filter-helper" data-unique-filter="KPI:-"><?= t('Not assigned') ?></a></li>
                        <li><a href="#" class="filter-helper" data-unique-filter="assignee:anybody"><?= t('Assigned') ?></a></li>
                        <?php foreach ($users_list as $user): ?>
                            <li>
                                <a href="#" class="filter-helper" data-unique-filter='KPI:"<?= $this->text->e($user) ?>"'><?= $this->text->e($user) ?></a>
                            </li>
                        <?php endforeach ?>
                    </ul>
                </div>
