...
<div class="container">
    <?php if (empty($tasks)): ?>
        <div class="alert alert-info"><?= t('No open tasks found.') ?></div>
    <?php else: ?>
                ...
                <table class="kb-table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th width="150"><a href="<?= $sortUrl('column') ?>" class="kpi-sort-link"><?= t('Column') ?> <?= $sortIcon('column') ?></a></th>
                    ...
                    <?php foreach ($tasks as $task): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?= $assigneeAvatarService ? $assigneeAvatarService->renderAssignees($task['assignee_id'], $ownerId, 'avatar-inline', 20) : t('-') ?>
                            </td>
